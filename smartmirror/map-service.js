(function(annyang) {
    ...
    function MapService() {
		...
		console.log("map:"+targetCenter);
            return "https://maps.googleapis.com/maps/api/js?key=AIzaSyAZULD1KGoiKyuQEs0ZMCnZad-gFV8f-dA&center="+targetCenter+"&zoom="+targetZoom+
